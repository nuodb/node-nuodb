...
class Pool {
  ...
  async _createConnection() {
    // added this to make line 157 work
    let all_connections_array = Object.keys(this.all_connections);
    if (this.config.hardLimit > 0) {
      if (all_connections_array.length() >= this.config.hardLimit) {
